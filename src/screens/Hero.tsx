          ...
          <SwiperSlide key={i}>
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
                ...
                <p className="text-white/90 text-lg mt-4 max-w-2xl drop-shadow">
                  {item.desc}
                </p>

                <div className="flex gap-4 mt-8">
                  <button className="px-6 py-3 bg-white text-black font-semibold rounded-lg shadow hover:bg-neutral-200 transition">
                    Lihat Template
                  </button>
                  <button className="px-6 py-3 bg-transparent border border-white text-white font-semibold rounded-lg hover:bg-white/10 transition">
                    Beli Sekarang
                  </button>
                </div>
              </div>
