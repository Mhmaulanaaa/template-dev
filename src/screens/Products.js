...
export default function Products() {
    return (_jsxs("section", { id: "products", className: "min-h-screen px-6 py-20 max-w-6xl mx-auto", children: [_jsx("h3", { className: "text-4xl font-extrabold text-center mb-5 bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent", children: "Template Premium Unggulan" }), _jsx("p", { className: "text-center text-gray-600 max-w-2xl mx-auto mb-10", children: "Koleksi template modern dan berkualitas tinggi yang siap pakai untuk website, landing page, dashboard, dan aplikasi bisnis Anda." }), _jsx("div", { className: "grid md:grid-cols-3 gap-10", children: products.map((p) => (_jsx(ProductCard, { product: p }, p.id))) })] }));
}
